            ...
            >
              ...
              >
                <VStack
                  ...
                  alignItems="start"
                >
                  <Feature>1 month setup time</Feature>
                  <Feature>All automated support, website with FAQ</Feature>
                  <Feature>
                    Automated chat bot that answers basic questions
                  </Feature>
                  <Feature>
                    Ticketing system in place – consultation on picking a
                    ticketing platform, implementation
                  </Feature>
                  <Feature>
                    Actual price may change depending on client company size and
                    needs
                  </Feature>
                  <Feature>
                    Leverage social media for complaints + mentions
                  </Feature>
                  <Feature>Leverage online forums for common q&a</Feature>
                  <Feature>Surveys + Metrics</Feature>
                </VStack>
                <Box
                  w="full"
                  ml={3}
